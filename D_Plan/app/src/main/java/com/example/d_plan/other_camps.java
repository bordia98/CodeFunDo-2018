...
public class other_camps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.other_camps);
        Toolbar toolbar =(Toolbar)findViewById(R.id.my_toolbar);
        assert toolbar != null;
        toolbar.setTitle("Camps List");
        ...
        try {
            mClient = new MobileServiceClient("https://d-plan.azurewebsites.net", this).withFilter(new other_camps.ProgressFilter());
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            for (Local_help item : results) {
                                if( !(item.getemail().equals(mail)) && item.isComplete()==false && item.getAuth()==true)
                                    mAdapter.add(item);
                            }
                        }
                    });
