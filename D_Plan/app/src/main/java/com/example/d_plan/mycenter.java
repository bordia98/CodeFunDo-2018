...
import static com.microsoft.windowsazure.mobileservices.table.query.QueryOperations.lt;
...
public class mycenter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            mClient = new MobileServiceClient("https://d-plan.azurewebsites.net", this).withFilter(new mycenter.ProgressFilter());
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            for (Local_help item : results) {
                                if( item.getText_did().equals(did) && item.isComplete()==false)
                                    mAdapter.add(item);
                            }
                        }
                    });
